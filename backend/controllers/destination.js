...
const createDestination = async (req, res) => {
    ...
    try {
        ...
        await query('INSERT INTO techtrek24.destination (country_id, cost, name, notes) VALUES (1, ?, ?, ?)', [cost, name, notes]);
...
const deleteDestination = async (req, res) => {
    ...
    try {
        ...
        await query('delete from techtrek24.destination where id = ?', [destinationid]);
...
const updateDestination = async (req, res) => {
    ...
    try {
        ...
        await query('Update techtrek24.destination Set cost = ?,  name = ?, notes = ? where id = ?', [cost, name, notes, id]);
